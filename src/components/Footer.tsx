...
const Footer = () => {
  const footerLinks = [
    { label: "About REACH Furniture Nester", path: "/about" },
    { label: "Benefits of REACH Furniture Nester", path: "/benefits" },
    // { label: "Learning Guides", path: "/learningguide" },
    // { label: "Presentations", path: "/presentations" },
    { label: "REACH Furniture Nester Images", path: "/rmmimages" },
          ...
          <div>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                <img src={emailIcon} alt="Email icon for contacting REACH Furniture Nester" className="w-8 icon-a31951" />
              ...
              >
                <img src={whatsappIcon} alt="Whatsapp icon for REACH Furniture Nester" className="w-8 icon-a31951" />
                <span className="text-gray-300 text-lg">
                  +91 84592 78496
                </span>
              </a>
              ...
              >
                <img src={contactIcon} alt="Contact form icon for REACH Furniture Nester" className="w-7 icon-a31951" />
                <span className="text-gray-300 text-lg">
                  Write to Us
                </span>
              </a>
